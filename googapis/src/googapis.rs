...
pub mod google {
                ...
                pub mod schema {
                    pub mod predict {
                        pub mod instance {
                            ...
                            include_proto!("google.cloud.aiplatform.v1.schema.predict.instance");
                        }
                        pub mod params {
                            #[cfg(any(
                                feature = "google-cloud-aiplatform-v1-schema-predict-params",
                            ))]
                            include_proto!("google.cloud.aiplatform.v1.schema.predict.params");
                        }
                        pub mod prediction {
                            #[cfg(any(
                                feature = "google-cloud-aiplatform-v1-schema-predict-prediction",
                            ))]
                            include_proto!("google.cloud.aiplatform.v1.schema.predict.prediction");
                        }
                    }
                    pub mod trainingjob {
                        pub mod definition {
                ...
                pub mod schema {
                    ...
                    pub mod predict {
                        ...
                        pub mod params {
                            ...
                            include_proto!("google.cloud.aiplatform.v1beta1.schema.predict.params");
                        }
                        pub mod prediction {
                            #[cfg(any(
                                feature = "google-cloud-aiplatform-v1beta1-schema-predict-prediction",
            ...
            pub mod airflow {
                pub mod service {
                    ...
                    pub mod v1beta1 {
                        ...
                        include_proto!("google.cloud.orchestration.airflow.service.v1beta1");
                    }
                }
            }
        }
            ...
            pub mod management {
                pub mod logs {
                    pub mod v1 {
                        ...
                        include_proto!("google.cloud.saasaccelerator.management.logs.v1");
                    }
                }
            }
        }
    ...
    pub mod firestore {
        ...
        pub mod v1 {
            #[cfg(any(feature = "google-firestore-bundle", feature = "google-firestore-v1",))]
