...
pub mod private_catalog_client {
    ...
    use tonic::codegen::*;
    #[doc = " `PrivateCatalog` allows catalog consumers to retrieve `Catalog`, `Product`"]
    #[doc = " and `Version` resources under a target resource context."]
    #[doc = ""]
    #[doc = " `Catalog` is computed based on the [Association][]s linked to the target"]
    #[doc = " resource and its ancestors. Each association's"]
    #[doc = " [google.cloud.privatecatalogproducer.v1beta.Catalog][] is transformed into a"]
    #[doc = " `Catalog`. If multiple associations have the same parent"]
    #[doc = " [google.cloud.privatecatalogproducer.v1beta.Catalog][], they are"]
    #[doc = " de-duplicated into one `Catalog`. Users must have"]
    #[doc = " `cloudprivatecatalog.catalogTargets.get` IAM permission on the resource"]
    #[doc = " context in order to access catalogs. `Catalog` contains the resource name and"]
    #[doc = " a subset of data of the original"]
    #[doc = " [google.cloud.privatecatalogproducer.v1beta.Catalog][]."]
    #[doc = ""]
    #[doc = " `Product` is child resource of the catalog. A `Product` contains the resource"]
    #[doc = " name and a subset of the data of the original"]
    #[doc = " [google.cloud.privatecatalogproducer.v1beta.Product][]."]
    #[doc = ""]
    #[doc = " `Version` is child resource of the product. A `Version` contains the resource"]
    #[doc = " name and a subset of the data of the original"]
    #[doc = " [google.cloud.privatecatalogproducer.v1beta.Version][]."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Search [Catalog][google.cloud.privatecatalog.v1beta1.Catalog] resources that consumers have access to, within the"]
        #[doc = " scope of the consumer cloud resource hierarchy context."]
        ...
        #[doc = " Search [Product][google.cloud.privatecatalog.v1beta1.Product] resources that consumers have access to, within the"]
        #[doc = " scope of the consumer cloud resource hierarchy context."]
        ...
        #[doc = " Search [Version][google.cloud.privatecatalog.v1beta1.Version] resources that consumers have access to, within the"]
        #[doc = " scope of the consumer cloud resource hierarchy context."]
