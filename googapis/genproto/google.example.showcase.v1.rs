...
pub mod echo_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn echo(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.example.showcase.v1.Echo/Echo",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.example.showcase.v1.Echo/Expand",
            );
        ...
        pub async fn collect(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.example.showcase.v1.Echo/Collect",
            );
            self.inner
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.example.showcase.v1.Echo/Chat",
            );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.example.showcase.v1.Echo/Wait",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn block(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.example.showcase.v1.Echo/Block",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
